...
export default function Login() {
    ...
    const pathRedirect = sessionStorage.getItem("savedPage") || "/home";

    useEffect(() => {
        if (actionData?.success){
            loginSuccess(actionData.jwtToken, actionData.userDto);
...
export async function loginAction({request}) {
    ...
    const responseObj = await saveLoginData(loginData);
    return responseObj;
}